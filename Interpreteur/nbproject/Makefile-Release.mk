...
${OBJECTDIR}/Type.o: Type.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Type.o Type.cpp
...
${TESTDIR}/_ext/1472/newtestclass1.o: ../newtestclass1.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/1472/newtestclass1.o ../newtestclass1.cpp


${TESTDIR}/_ext/1472/noeudInstPourTestRunner.o: ../noeudInstPourTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/1472/noeudInstPourTestRunner.o ../noeudInstPourTestRunner.cpp
...
${OBJECTDIR}/Procedure_nomain.o: ${OBJECTDIR}/Procedure.o Procedure.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Procedure_nomain.o Procedure.cpp;\
	else  \
...
${OBJECTDIR}/Type_nomain.o: ${OBJECTDIR}/Type.o Type.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Type_nomain.o Type.cpp;\
	else  \
