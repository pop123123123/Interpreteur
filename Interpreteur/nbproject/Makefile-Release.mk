...
${TESTDIR}/_ext/5c0/newtestclass1.o: ../newtestclass1.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/5c0/newtestclass1.o ../newtestclass1.cpp


${TESTDIR}/_ext/5c0/noeudInstPourTestRunner.o: ../noeudInstPourTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/5c0/noeudInstPourTestRunner.o ../noeudInstPourTestRunner.cpp
